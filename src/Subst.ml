...
and substCom ss = function
  ...
  | (CCase _ | CSkip | CAssert _ | CSwap _ | CLocalD _ | CFor _) as c -> substCom ss (Desugar.desugar_com c)
...
and varsCom = function
  ...
  | (CCase _ | CSkip | CAssert _ | CSwap _ | CLocalD _ | CFor _) as c -> varsCom (Desugar.desugar_com c)
