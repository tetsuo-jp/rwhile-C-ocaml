...
## 0.5. 直接の親論文 — IEICE 2025（Okubo–Yokoyama）

`~/dev/overleaf/2025_Reversible_Projection_IEICE_D/paper123.tex`（研究速報 OkYo26 の拡張）。
...
（`2024_okubo`「可逆二村射影」）／研究速報 OkYo26**（fp1 不成立＋第1可逆射影）。dblp 公開索引には
未掲載（IEICE 和文・直近のため）。論文化での分担：**理論・正当性・具体化の枠組み＝親論文／
