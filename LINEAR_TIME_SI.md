...
（見積りではない）。現在値（`pair?` 追加後・2026-08-05）と基準値:

| 定数 | M=0 | M=1 | 傾き | 基準（pair? 前） |
|---|---:|---:|---:|---:|
| `CC` | 3196 | 6136 | 2940 | 3184 |
| `lpDStep` | 464 | 944 | 480 | 462 |
| `lpAStep` | 444 | 924 | 480 | 442 |
| `assStep` | 429 | 969 | 540 | 427 |
| `condStep` | 445 | 925 | 480 | 443 |
| `condEStep` | 470 | 950 | 480 | 468 |
| `evalB` | 179 | 419 | 240 | 178 |
